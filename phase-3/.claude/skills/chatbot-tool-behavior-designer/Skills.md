name: chatbot-tool-behavior-designer
description: Designs MCP tools and NL behaviors for Phase 3 chatbot integration into Phase 2 app. Covers stateless architecture, Better Auth, and animated ChatKit UI.

## Chatbot Tool & Behavior Designer
